		...
		<div class="navbar w-4/5">
			<div class="navbar-start">
				<div class="dropdown">
					...
					<ul
						tabindex="0"
						class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-62"
					>
			...
			<div class="navbar-center">
				<a href="/" class="btn btn-ghost normal-case text-2xl">waffleship.io</a>
			</div>
